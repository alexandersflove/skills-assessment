## My Attempt
This is my attempt at the skills assessment. I put an emphasis on sticking within the suggested amount of time spent. With more time I would have liked to get everything more exact in terms of matching the spec. I thought this was a fun little exercise and it made me realize that if anything, I need to spend a little time becoming more efficient with pulling from a photoshop file, as I am more familiar with Adobe XD, which makes things a lot easier. 

If I had more time I would have finished the overlay for when a  contact is clicked and added some conditional logic for what to display depending on whether email address or phone number was selected. 
